...
public class GUITemplate {
    ...
    public static GUITemplate fromConfig(FileConfiguration config){
        ...
        for(String s : itemsSection.getKeys(false)){
            ConfigurationSection item = itemsSection.getConfigurationSection(s);
            if(item == null) continue;

            items.put(itemsSection.getIntegerList(s+".slots"), ConfigUtils.getItem(item));
            Set<String> keys = item.getKeys(false);
